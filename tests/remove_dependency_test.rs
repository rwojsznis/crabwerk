...
fn test_remove_dependency() {
    ...
    crabwerk_remove_dependency(tmp, "packs/foo", "packs/baz")
        .success()
...
fn test_remove_only_dependency() {
    ...
    crabwerk_remove_dependency(tmp, "packs/foo", "packs/bar").success();
...
fn test_remove_dependency_that_does_not_exist_is_a_no_op() {
    ...
    crabwerk_remove_dependency(tmp, "packs/foo", "packs/bar")
        .success()
        .stdout(predicate::str::contains(
...
fn test_remove_dependency_with_unknown_from_pack() {
    ...
    crabwerk_remove_dependency(tmp, "packs/nope", "packs/bar")
        .failure()
...
fn test_remove_dependency_with_unknown_to_pack() {
    ...
    crabwerk_remove_dependency(tmp, "packs/foo", "packs/nope")
        .failure()
        .stderr(predicate::str::contains("`packs/nope` not found"));
}
